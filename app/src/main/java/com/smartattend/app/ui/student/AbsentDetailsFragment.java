...
public class AbsentDetailsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tvTitle.setText("Absent Details");
        binding.tvTitle.setTextColor(0xFFEF4444);
        ...
        attendanceViewModel.studentRecords.observe(getViewLifecycleOwner(), records -> {
            ...
            for (AttendanceRecord r : records) {
                if (!r.isGeoVerified() || !r.isFaceVerified() || r.isProxyBlocked()) {
                    absentRecords.add(r);
                }
            }
            binding.rvAttendance.setAdapter(new AttendanceAdapter(absentRecords));
        });
    }
